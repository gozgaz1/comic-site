...
const ComicContainer = (props) => {
    ...
    The container is ACTUALLY the page itself.
    ...
    return (
        ...
        <div className="img-grid">
            ...
            <motion.div className="img-wrap" key={doc.id} 
                ...
                onClick={async() => {await props.changeFullChapter(doc.chapter); setModalOpen(true);}}
            >
        ...
        {modalOpen && <ComicReaderModal
            fullChapterDoc={props.fullChapterDoc}
            modalOpen={modalOpen}
